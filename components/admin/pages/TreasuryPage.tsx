...
export const TreasuryPage: React.FC = () => {
    ...
    const handleInvoiceClick = (e: React.MouseEvent, type: string, id: number) => {
        e.preventDefault();
        const page = type === 'purchase' ? 'purchaseInvoices' : 'salesInvoices';
        navigate(`/admin/${page}?view_${type}=${id}`);
    }
