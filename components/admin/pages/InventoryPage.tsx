...
export const InventoryPage: React.FC<InventoryPageProps> = ({ pageType }) => {
        ...
        const checkUrlForInvoice = () => {
            ...
            if (purchaseId && purchaseInvoices.length > 0) {
                ...
                if (invoiceToView) {
                    ...
                    // Clean up URL
                    navigate(`/admin/${pageType}`, { replace: true });
                }
    ...
    }, [isInventoryLoading, purchaseInvoices, salesInvoices, setViewingInvoice, setViewingSalesInvoice, pageType, location.search, navigate]);
